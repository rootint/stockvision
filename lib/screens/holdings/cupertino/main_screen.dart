          ...
          itemBuilder: ((context, index) {
            if (index == 0) {
              return Column(
                ...
                children: [
                  HoldingsCard(holdings: holdings, darkModeEnabled: darkModeEnabled),
                  const Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              CupertinoButton(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: RichText(
                      text: TextSpan(
                        text: getDeltaString(
                            holdings, allTimeSwitchProvider.isSwitchEnabled),
                        style: TextStyle(
                            color: getDeltaColor(
                                holdings, allTimeSwitchProvider.isSwitchEnabled)
                            // fontWeight: FontWeight.w600,
                        ...
                        children: [
                          TextSpan(
                            text: allTimeSwitchProvider.isSwitchEnabled
                                ? ' for all time'
                                : ' for today',
                            style: TextStyle(
                              color: kPrimaryColor,
                ...
                onPressed: () => allTimeSwitchProvider.onAllTimeSwitch(),
              ),
            ],
          ),
        ),
